...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_vj0imww', 'template_94jgg7q', formRef.current, 'user_Bkg3VE6jPJZCdIcbbIPc9')
      .then((result) => {
            ...
            <div className="cont-wrapper">
                <div className="cont-left">
                    ...
                    <div className="cont-info">
                        ...
                        <div className="cont-info-item">
                            <img src={Email} alt="" className="cont-icon" />kellywizzyisong@gmail.com
                        </div>
                        <div className="cont-info-item">
