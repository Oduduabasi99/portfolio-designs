    ...
    <div className="intro">
      <div className="intro-left">
        <div className="intro-left-wrapper">
          ...
          <a href="#"><FaLinkedin className="social-icon" size='1.3em' /></a>
          <a href="#"><FaTwitter className="social-icon" size='1.3em' /></a>
          <a href="#"><FaFacebook className="social-icon" size='1.3em' /></a>
          <a href="#"><FaInstagram className="social-icon" size='1.3em' /></a>
          <a href="#"><FaWhatsapp className="social-icon" size='1.3em' /></a>
          </div>
        
          <h2 className="intro-intro">Hello, My name is</h2>
          <h1 className="intro-name">Oduduabasi Isong</h1>
          ...
          <a href={Resume} download="OduduIsong cv.pdf" className="intro-cv">
